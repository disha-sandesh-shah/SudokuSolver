...
public class Solver {
    ...
    public void setNumberPos(int num) {
        if(this.selected_row != -1 && this.selected_column != -1) {
            if(this.board[this.selected_row-1][selected_column-1] == num) {
                this.board[this.selected_row-1][selected_column-1] = 0;
            } else {
                this.board[this.selected_row-1][selected_column-1] = num;
            }
        }
    }
